...
# testAcc.append(utils.evaluate(clf, trainData))
utils.evaluate(clf, trainData)

print('\nEvaluate your classifier with test dataset')
utils.evaluate(clf, testData)
# trainAcc.append(utils.evaluate(clf, testData))

# for i in range(len(testAcc)): 
    # print("%d: %f, %f" % (i+1, testAcc[i], trainAcc[i]))
# '''
...
detection.detect('data/detect/myDetect.txt', clf)
# '''
